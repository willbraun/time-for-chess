...
export function SessionBar() {
	...
	return (
		<Pressable
			...
			className='flex-row items-center justify-center px-4 gap-4 h-15 bg-app-primary'
		>
			<Text className='text-white text-xl font-semibold'>{activeSession.category_name}</Text>
			<Text
				className='text-white bg-app-bg/20 px-2 py-1 rounded text-xl font-bold'
...
export function SessionFAB() {
	...
	return (
		...
		>
			<Pressable
				onPress={() => router.push('/session' as any)}
				className='bg-app-primary rounded-2xl px-8 py-4'
				style={{
					elevation: 8,
					width: '90%',
					shadowColor: '#000',
